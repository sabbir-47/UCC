...
Grid'5000 test bed. Results show that, application can reduce brown energy consumption by 35\% and daily instance hour cost by 37\% compared to a baseline approach when green aware adaptation is considered.
\end{abstract}
